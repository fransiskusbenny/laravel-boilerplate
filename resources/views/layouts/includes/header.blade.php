<div class="header ">
    ...
    <div class="">
        <div class="brand inline">
            <img src="{{ asset('vendor/assets/img/logo.png') }}"
                 alt="logo" data-src="{{ asset('vendor/assets/img/logo.png') }}"
                 data-src-retina="{{ asset('vendor/assets/img/logo_2x.png') }}"
                 width="78" height="22"
            />
        </div>
                                    ...
                                    <div class="heading">
                                        <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                            <img width="30" height="30"
                                                 data-src-retina="{{ asset('vendor/assets/img/profiles/1x.jpg') }}"
                                                 data-src="{{ asset('vendor/assets/img/profiles/1.jpg') }}" alt=""
                                                 src="{{ asset('vendor/assets/img/profiles/1.jpg') }}">
                                        </div>
                                        <a href="#" class="text-complete pull-left">
        ...
        <a href="#" class="search-link hidden-md-down" data-toggle="search"><i class="pg-search"></i>Type anywhere
            to <span class="bold">search</span>
        </a>
    </div>
    <div class="d-flex align-items-center">
        <!-- START User Info-->
        <div class="pull-left p-r-10 fs-14 font-heading hidden-md-down">
            <span class="semi-bold">{{ $login_user->name }}</span>
        </div>
        <div class="dropdown pull-right hidden-md-down">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                <span class="thumbnail-wrapper d32 circular inline">
                    <img src="{{ get_gravatar($login_user->email) }}"
                         data-src="{{ get_gravatar($login_user->email) }}"
                         data-src-retina="{{ get_gravatar($login_user->email, 160) }}"
                         width="32" height="32"
                    />
                </span>
            </button>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                <a href="{{ route('account') }}" class="dropdown-item"><i class="fa fa-user"></i> Account</a>
