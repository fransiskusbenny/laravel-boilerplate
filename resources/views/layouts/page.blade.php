...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">`
            <div class="content">
               {!! Breadcrumbs::render() !!}
                <div class="container-fluid container-fixed-lg {{ isset($bg) ? $bg: '' }}">
                    @yield('page_content')
                </div>
            </div>
                    ...
                    <div class="view bg-white">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34"
                                 data-src-retina="/vendor/assets/img/profiles/1x.jpg"
    ...
    <div class="overlay hide" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                <!-- BEGIN Overlay Logo !-->
                <img class="overlay-brand" src="/vendor/assets/img/logo.png" alt="logo"
                     data-src="/vendor/assets/img/logo.png"
